...
-- While these look similar, the difference lies in the values held by each type. Both
-- are type constructors that accept a single concrete type, however ((,) e) holds
